    ...
    return (
        <>
            ...
            <p className="mt-6 text-zinc-700 dark:text-zinc-300">
                By using Q-uills you agree to the terms below. We've kept them short and
                in plain English — a full agreement signed at booking time will follow once
                we enable in-app payments.
            </p>

            <h2 className="mt-10 text-xl font-semibold">1. What Q-uills does</h2>
            <p className="mt-3 text-zinc-700 dark:text-zinc-300">
                Q-uills is a discovery and booking service. We curate rental listings
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-zinc-700 dark:text-zinc-300">
                ...
                <li>Q-uills acts as an introducer; the lease is a private agreement
            ...
            <p className="mt-3 text-zinc-700 dark:text-zinc-300">
                Q-uills is provided "as is" during the pilot. We do our best to verify
